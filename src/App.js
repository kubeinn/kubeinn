...
function App() {
  return (
    <Admin customRoutes={customRoutes} loginPage={LoginPage} logoutButton={LogoutButton} history={history} dashboard={Dashboard} authProvider={AuthProvider} dataProvider={DataProvider}>
